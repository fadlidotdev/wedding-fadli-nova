...
export default function SectionMessage({ name }) {
  ...
  const handleSubmit = async (e) => {
    ...
    await supabase.from("messages").insert([state]).select();

    toast.success("Berhasil terkirim!");

    setState({ name, message: "", attendance: "hadir" });
    fetchData();
    // if (typeof window !== "undefined") localStorage.setItem("hasSent", "yes");
    // setHasSent(true);
  };

  return (
    <section className="px-8 py-20 flex flex-col relative  items-center overflow-hidden bg-[#822223]">
      ...
      <div className="z-20 flex flex-col w-full gap-4">
        <div
          ...
          data-aos-once="true"
          className="flex flex-col text-center text-[#ece5db]"
        >
        ...
        {hasSent ? (
          <p className="text-[#ece5db] p-2 text-sm border border-dotted w-full opacity-50 rounded-lg">
            Kamu sudah mengirim pesan.
          </p>
        ) : (
          <form
            className="flex flex-col w-full gap-3 p-4 bg-[#ece5db] rounded-lg"
          ...
          >
            <div>
              ...
              <input
                ...
                id="nama"
                name="name"
                className="bg-[#ece5db] border border-[#822223] text-sm rounded-lg block w-full p-2.5 focus-visible:outline-[#822223] outline-1"
            ...
            <div>
              ...
              <textarea
                ...
                name="message"
                rows={4}
                className="block p-2.5 w-full text-sm bg-[#ece5db] rounded-lg border border-[#822223] focus-visible:outline-[#822223] outline-1"
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select
                  id="kehadiran"
                  name="attendance"
                  className="relative bg-[#ece5db] border  border-[#822223] text-sm rounded-lg block w-full p-2.5 focus-visible:outline-[#822223] outline-1 appearance-none"
                  required
            ...
            <button
              type="submit"
              className="mt-3 text-[#ece5db] bg-[#822223] hover:bg-[#52331a] font-medium rounded-lg px-5 py-2 text-sm"
            >
              Kirim
            </button>
          </form>
