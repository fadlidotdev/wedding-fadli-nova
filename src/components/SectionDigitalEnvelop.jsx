...
export default function SectionDigitalEnvelop() {
  ...
  return (
    <section className="px-8 pt-16 pb-28 bg-[#822223] relative">
      <div className="relative z-10">
        <div className="flex flex-col text-center text-[#ece5db] mb-8">
          ...
          >
            <p className="opacity-50">
              Your Blessing is a meaningful gift to us. And if giving is an expression of your love,
              you can give a cashless gift.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          >
            <div>
              <h3 className="mb-1.5 text-xl font-semibold">Fadli Hidayatullah</h3>
              <p className="flex items-center gap-2 tracking-wider">
                0581 4743 50{" "}
                <button
                  onClick={() => {
